            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                    ...
                    if(rb_byRoute.isChecked())
                {
                    ...
                    try
                    {
                        header.setVisibility(View.GONE);
                        ll_overallDetails.setVisibility(View.GONE);
                        CommonFunction.getAllAddedOutletSummaryReportModel(AddedOutletSummaryReportActivity.this,token,CommonInfo.RegistrationID,"Please wait generating report.",flgToCall);
