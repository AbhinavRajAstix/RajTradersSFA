...
public class CheckDatabaseDataOrderBooking extends BaseActivity
{

	ArrayAdapter<String> dataAdapter = null;
	String[] storeNames;
	TextView txtSalessumuryDate;
	...
	{
		String todayDate = TimeUtils.getNetworkDate(this,TimeUtils.DATE_FORMAT);
		hmapStore_details= mDataSource.fetch_Store_List(todayDate);
	...
	public void initialization()
	{
		...
		txtSalessumuryDate.setText(R.string.txtTodaySubmitData);
		...
		but_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(back.equals("0")) {
					// TODO Auto-generated method stub
					Intent ide = new Intent(CheckDatabaseDataOrderBooking.this, StoreSelection.class);
