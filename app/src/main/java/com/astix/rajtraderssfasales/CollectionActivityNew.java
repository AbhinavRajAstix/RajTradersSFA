...
import com.astix.rajtraderssfasales.printer.DeviceListActivity;
import com.astix.rajtraderssfasales.printer.UnicodeFormatter;
...
*/
                                ...
                                locationRetreivingGlobal.locationRetrievingAndDistanceCalculating(CollectionActivityNew.this, true, true, 100, 0);
   ...
   /* private void allMessageAlert(String message) {
    ...
    public String genCollectionCode() {
     ...
     /*   String val1 = tokens.nextToken().trim();
        ...
        String  sdcxz = "Collection" + "-" + IMEIid + "-" + randomString + "-" + VisitStartTS.replace(" ", "").replace(":", "").trim();
...
*/
    ...
    public boolean validate_flgCollDefControl(){
     /*  CommonInfo.flgCollDefControl=3;
        ...
        if(CommonInfo.flgCollDefControl==0){
            return true;
        }
