...
public class DailyWorkingWebReport extends AppCompatActivity {
    ...
    private String mCM;
    private static final String TAG = DailyWorkingWebReport.class.getSimpleName();
    ...
    private void initWebView() {
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(DailyWorkingWebReport.this.getPackageManager()) != null) {
       ...
       /* if (webPageType == 2){
            ...
            completeURL = CommonInfo.WEB_Daily_Working_Report + AppUtils.getToken(DailyWorkingWebReport.this);
      //  }
