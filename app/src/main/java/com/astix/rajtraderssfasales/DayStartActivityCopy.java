...
public class DayStartActivityCopy extends BaseActivity implements LocationInterface,OnMapReadyCallback,CompoundButton.OnCheckedChangeListener,InterfaceRetrofit,DatePickerDialog.OnDateSetListener
{
        ...
        String FnlAddress="NA",finalPinCode="0",finalCity="NA",finalState="NA",fnAccurateProvider="NA",AllProvidersLocation="NA",FusedAddress="NA",GpsLat="0",GpsLong="0"
                ,GpsAccuracy="0",GpsAddress="NA",NetwLat="0",NetwLong="0",NetwAccuracy="0" ,NetwAddress="NA",FusedLat="0",FusedLong="0",FusedAccuracy="0"
                ,FusedLocationLatitudeWithFirstAttempt="0" ,FusedLocationLongitudeWithFirstAttempt="0",FusedLocationAccuracyWithFirstAttempt="0";
                ...
                if(intentFrom==0)
                {
                        ...
                        imgVw_next.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                        ...
                                        Intent i=new Intent(DayStartActivityCopy.this,AllButtonActivity.class);
                                        startActivity(i);
                                        finish();
                ...
                else
                {
                        ...
                        imgVw_back.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                        ...
                                        Intent i=new Intent(DayStartActivityCopy.this,StoreSelection.class);
        ...
        private void createRadioButtonForNotWorking()
        {
                ...
                fromDate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View arg0) {
                                ...
                                datePickerDialog = DatePickerDialog.newInstance(DayStartActivityCopy.this, Year, Month, Day);
        ...
        public void fnGetDistributorList()
        {
                ...
                adapterDBR= new ArrayAdapter<String>(DayStartActivityCopy.this,R.layout.initial_spinner_text,DbrArray);
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
                ...
                ctx=this;
                        ...
                        imei = AppUtils.getToken(DayStartActivityCopy.this);
...
//                    isGPSok = false;
                                ...
                                else
                                {
                                        ...
                                        llaaa.locationRetrievingAndDistanceCalculating(DayStartActivityCopy.this,false, true, 20, 0);
                ...
                fDate = TimeUtils.getNetworkDateTime(DayStartActivityCopy.this,TimeUtils.DATE_FORMAT);
                ...
                adapterLocation = new ArrayAdapter<String>(DayStartActivityCopy.this, android.R.layout.simple_spinner_item,listLocationWrkng);
                ...
                if( CommonInfo.hmapAppMasterFlags!=null && CommonInfo.hmapAppMasterFlags.get("flgDistributorCheckIn")==0) {
                ...
                but_DayStart.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view)
                        {
                                ...
                                else
                                {
                                        ...
                                        mapFrag.getMapAsync(DayStartActivityCopy.this);
                                        ...
                                        LocationRetreivingGlobal llaaa=new LocationRetreivingGlobal();
                                        llaaa.locationRetrievingAndDistanceCalculating(DayStartActivityCopy.this,true,true,20,1);
                                        ...
                                        if(rb_workingYes.isChecked()) {
                                                if (parseDateTime(crntServerTime).after(crntDateTime(crntAttndncTime)) && flgCheckForLateReason==1) {
                                                        if (reasonId.equals("0")) {
                                                                AlertDialog.Builder alertDialog = new AlertDialog.Builder(DayStartActivityCopy.this);
...
*/
                                                                        ...
                                                                        mDataSource.updatetblAttandanceDetails("33","No Working",ReasonId,ReasonText,commentValue,DistributorId_Global,DistributorNodeType_Global,DistributorName_Global,LeaveStartDate,LeaveEndDate,"","");
...
*/
        ...
        {
                AppUtils.doCheckGPSEnable(DayStartActivityCopy.this);
        }
        ...
        {
                AlertDialog.Builder alertDialogNoConn = new AlertDialog.Builder(DayStartActivityCopy.this);
        ...
        public String displayAlertDialog()
        {
                ...
                ArrayAdapter adapterCategory=new ArrayAdapter(DayStartActivityCopy.this, android.R.layout.simple_spinner_item,reasonNames);
        ...
        public void onLocationRetrieved(String fnLati, String fnLongi, String finalAccuracy, String fnAccurateProvider, String GpsLat, String GpsLong, String GpsAccuracy, String NetwLat, String NetwLong, String NetwAccuracy, String FusedLat, String FusedLong, String FusedAccuracy, String AllProvidersLocation, String GpsAddress, String NetwAddress, String FusedAddress, String FusedLocationLatitudeWithFirstAttempt, String FusedLocationLongitudeWithFirstAttempt, String FusedLocationAccuracyWithFirstAttempt, int flgLocationServicesOnOff, int flgGPSOnOff, int flgNetworkOnOff, int flgFusedOnOff, int flgInternetOnOffWhileLocationTracking, String address, String pincode, String city, String state, String fnAddress) {
                ...
                if(!checkLastFinalLoctionIsRepeated(String.valueOf(fnLati), String.valueOf(fnLongi), String.valueOf(finalAccuracy)))
                {
                        ...
                        mDataSource.savetblAttandanceDetails(txt_DayStarttime.getText().toString().trim(),PersonNodeID,PersonNodeType,PersonName,OptionID,OptionDesc,
                                ...
                                flgFusedOnOff,flgInternetOnOffWhileLocationTracking,flgRestart, cityID, StateID, MapAddress, MapCity, MapPincode, MapState,fDate,LeaveStartDate,LeaveEndDate,"","");
                ...
                else
                {
                        ...
                        {
                                android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(DayStartActivityCopy.this);
        ...
        private class bgTasker extends AsyncTask<Void, Void, Void> {
                ...
                protected void onPreExecute()
                {
                        ...
                        pDialog2 = ProgressDialog.show(DayStartActivityCopy.this,getText(R.string.PleaseWaitMsg),getText(R.string.genTermProcessingRequest), true);
                ...
                protected void onPostExecute(Void result) {
                        ...
                        if ((CommonInfo.hmapAppMasterFlags.get("flgTargetShowatStart") == 1)) {
                                Intent i = new Intent(DayStartActivityCopy.this, SalesValueTarget.class);
               ...
               /* else if ((CommonInfo.hmapAppMasterFlags.get("flgIncentiveShowtStart") == 1)) {
                    ...
                    finish();
                                ...
                                Intent intent = new Intent(DayStartActivityCopy.this, DistributorCheckInSecondActivity.class);
                                ...
                                Intent intent = new Intent(DayStartActivityCopy.this, WarehouseCheckInSecondActivity.class);
                                intent.putExtra("imei", imei);
                                intent.putExtra("fDate", fDate);
                                intent.putExtra("From", "DayStart");
                                startActivity(intent);
                                ...
                                if(rb_workingNo.isChecked())
                                {
                                      ...
                                      /*  Intent intent = new Intent(DayStartActivity.this, AllButtonActivity.class);
                                        ...
                                        if (isOnline()) {
                                                //   new CurrentDateTime().execute();
                                                CommonFunction.getAllMasterTableModelData(DayStartActivityCopy.this, AppUtils.getToken(DayStartActivityCopy.this  ), "","Please wait loading Data!", 3);
                                        }
...
//                }
        ...
        private void getReasonDetail()
        {
                ...
                if(hmapReasonIdAndDescr_details!=null)
                {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(DayStartActivityCopy.this, android.R.layout.simple_spinner_item,reasonLate);
        ...
        public void success() {
                ...
                Intent intent = new Intent(DayStartActivityCopy.this, AllButtonActivity.class);
                intent.putExtra("imei", imei);
                DayStartActivityCopy.this.startActivity(intent);
                finish();
//CommonInfo.crntServerTimecrntAttndncTime
        ...
        public String getDateAndTimeAMPM()
        {
                ...
                String curTime = TimeUtils.getNetworkDateTime(DayStartActivityCopy.this,TimeUtils.DATE_TIME_FORMAT);
                return curTime;
        }
        public EditText getEditText(String tagVal)
        {
                EditText editText=new EditText(DayStartActivityCopy.this);
