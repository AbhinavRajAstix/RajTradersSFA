...
public class DialogDayEndSummaryActivity extends BaseActivity implements InterfaceRetrofit,MultipleInterfaceRetrofit {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fDate = TimeUtils.getNetworkDateTime(DialogDayEndSummaryActivity.this,TimeUtils.DATE_FORMAT);
        ...
        spanString.setSpan(new ForegroundColorSpan(ContextCompat.getColor(DialogDayEndSummaryActivity.this, android.R.color.holo_blue_dark)), 0, spanString.length(), 0);
        ...
        tv_ViewPreviousDateTargets.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(DialogDayEndSummaryActivity.this,ReportPopUpSalesManTargetVsAchDayWise.class);
...
//targetvsachv_salesman_daily_target_row
    ...
    public void success() {
        ...
        if(isOnline())
        {
            ...
            try
            {
                mProgressDialogReport = new ProgressDialog(DialogDayEndSummaryActivity.this);
                ...
                CommonFunction.DateWiseTargetVsAchReportDownload reportDownloadAsyncTask = new CommonFunction.DateWiseTargetVsAchReportDownload(DialogDayEndSummaryActivity.this, mProgressDialogReport, interfaceRetrofit,0,0,0);
