...
public class DistributorCheckInFirstActivity extends BaseActivity implements LocationListener,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,OnMapReadyCallback, Camera.PictureCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(fDate==null)
        {
            ...
            fDate = TimeUtils.getNetworkDateTime(DistributorCheckInFirstActivity.this, TimeUtils.DATE_FORMAT);
        }
...
/*
    ...
    public void saveDataToDatabase()
    {
        ...
        try
        {
            ...
            intent.putExtra("From","DistributorCheckInFirstActivity");
            startActivity(intent);
            finish();
