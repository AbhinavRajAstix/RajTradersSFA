...
public class DistributorMapActivity extends BaseActivity implements LocationListener,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,OnMapReadyCallback, Camera.PictureCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        refreshCount=0;
        // mDataSource=new AppDataSource(DistributorMapActivity.this);
        ...
        if(fDate==null)
        {
            ...
            fDate = TimeUtils.getNetworkDateTime(DistributorMapActivity.this, TimeUtils.DATE_FORMAT);
        }
    ...
    public void fnGetDistributorList()
    {
        ...
        Distribtr_list=mDataSource.getSuplierDataMstr();
        //mDataSource.close();
...
/*
    ...
    public void saveDataToDatabase()
    {
       ...
       /* if (ll_gstDetails.getVisibility() == View.VISIBLE)
        ...
        //mDataSource.open();
        mDataSource.savetblSuplierMappingData(""+DistribtrId_Global,""+DistributorNodeType_Global,flgGSTCapture,flgGSTCompliance,
    ...
    private class FullSyncDataNow extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            newfullFileName= AppUtils.getToken(DistributorMapActivity.this) +"."+ TimeUtils.getNetworkDateTime(DistributorMapActivity.this,TimeUtils.DATE_TIME_FORMAT);;
            ...
            try {
                ...
                mDataSource.savetbl_XMLfiles(newfullFileName, "3","2");
                //mDataSource.open();

                mDataSource.UpdateDistributerFlag(UniqueDistribtrMapId, 4);


                //mDataSource.close();

                mDataSource.fnupdateSuplierMstrLocationtrackRemapFlg(UniqueDistribtrMapId);
