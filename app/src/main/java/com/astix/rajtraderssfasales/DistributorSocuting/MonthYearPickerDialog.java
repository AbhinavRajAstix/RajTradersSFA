...
public class MonthYearPickerDialog extends DialogFragment {
    ...
    InterfaceYearMonth interfaceYearMonth;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        interfaceYearMonth=(InterfaceYearMonth)getActivity();
        Calendar cal = Calendar.getInstance();

        View dialog = inflater.inflate(R.layout.distributor_scout_dateyear_selection, null);
        ...
        String mon = MONTHS[cal.get(Calendar.MONTH) + 1];
        monthPicker.setValue(mon);*/
        ...
        builder.setView(dialog).setPositiveButton(Html.fromHtml("<font color='#FF4081'>Ok</font>"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
              //  listener.onDateSet(null, yearPicker.getValue(), monthPicker.getValue(), 0);
                interfaceYearMonth.fnSelectedMonthYear(yearPicker.getValue(), monthPicker.getValue());
            }
