...
public class PhotoAdapterCheque extends RecyclerView.Adapter<PhotoAdapterCheque.PhotoViewHolder> {
    Context context;
    List<String> photos;
    String flgPhotoType;
    ...
    public PhotoAdapterCheque(Context context, List<String> photos, String flgPhotoType)
    {
