...
public class PhotoAdapterGST extends RecyclerView.Adapter<PhotoAdapterGST.PhotoViewHolder> {
    Context context;
    List<String> photos;
    String flgPhotoType;
    ...
    public PhotoAdapterGST(Context context, List<String> photos, String flgPhotoType)
    {
