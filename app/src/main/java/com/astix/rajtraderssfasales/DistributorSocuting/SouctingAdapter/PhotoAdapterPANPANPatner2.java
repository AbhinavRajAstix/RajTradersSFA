...
public class PhotoAdapterPANPANPatner2 extends RecyclerView.Adapter<PhotoAdapterPANPANPatner2.PhotoViewHolder> {
    Context context;
    List<String> photos;
    String flgPhotoType;
    ...
    public PhotoAdapterPANPANPatner2(Context context, List<String> photos, String flgPhotoType)
    {
