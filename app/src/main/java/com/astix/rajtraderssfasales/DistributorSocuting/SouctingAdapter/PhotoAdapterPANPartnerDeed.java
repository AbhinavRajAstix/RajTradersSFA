...
public class PhotoAdapterPANPartnerDeed extends RecyclerView.Adapter<PhotoAdapterPANPartnerDeed.PhotoViewHolder> {
    Context context;
    List<String> photos;
    String flgPhotoType;
    ...
    public PhotoAdapterPANPartnerDeed(Context context, List<String> photos, String flgPhotoType)
    {
