...
public class PhotoAdapterPANPatner1 extends RecyclerView.Adapter<PhotoAdapterPANPatner1.PhotoViewHolder> {
    Context context;
    List<String> photos;
    String flgPhotoType;
    ...
    public PhotoAdapterPANPatner1(Context context, List<String> photos, String flgPhotoType)
    {
