...
public class PhotoAdapterProprietorPAN extends RecyclerView.Adapter<PhotoAdapterProprietorPAN.PhotoViewHolder> {
    Context context;
    List<String> photos;
    String flgPhotoType;
    ...
    public PhotoAdapterProprietorPAN(Context context, List<String> photos, String flgPhotoType)
    {
