...
public class SocutingSelectionListAdapter extends RecyclerView.Adapter<SocutingSelectionListAdapter.ViewHolder> {
    ...
    public SocutingSelectionListAdapter(Context context, List<TblPotentialDistributor> tblPotentialDistributorList, String userDate, String pickerDate) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.scouting_distributor_row_selection_row, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.img_distribut_appointed.setVisibility(View.INVISIBLE);
        if(tblPotentialDistributor.getFlgAppointed()==1)
        {
            holder.img_distribut_appointed.setVisibility(View.VISIBLE);
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView img_removedistributor,img_viewDistributorDetails,img_distribut_appointed;
        ...
        public ViewHolder(View itemView) {
            ...
            img_distribut_appointed=itemView.findViewById(R.id.img_distribut_appointed);
