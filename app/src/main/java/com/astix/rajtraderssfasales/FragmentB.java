             ...
             public void onClick(View v) {
                 ...
                 else
                 {
                     ...
                     alertDialogNoConn.setNeutralButton("OK",
                          ...
                          syncIntent.putExtra("token",QuotationActivity.imei);
             ...
             public void onClick(View arg0) {
                 ...
                 else
                 {
                     ...
                     alertDialogNoConn.setNeutralButton("OK",
                          ...
                          /* token = getStorei.getStringExtra("token").trim();
     ...
     private class FullSyncDataNow extends AsyncTask<Void, Void, Void> {
         ...
         protected Void doInBackground(Void... params) {
             ...
             SimpleDateFormat df1 = new SimpleDateFormat("dd.MM.yyyy.HH.mm.ss",Locale.ENGLISH);
              ...
              newfullFileName= AppUtils.getToken(getActivity()) +"."+presentRoute+"."+ df1.format(dateobj);
