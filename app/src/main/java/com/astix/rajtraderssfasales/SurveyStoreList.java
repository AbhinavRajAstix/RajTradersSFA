...
public void backButtonFuntion(){
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if(getStorei !=null)
        {
            imei = getStorei.getStringExtra("token").trim();
    ...
    public void showAlertForEveryOne(String msg)
    {
        ...
        androidx.appcompat.app.AlertDialog.Builder alertDialogNoConn = new androidx.appcompat.app.AlertDialog.Builder(SurveyStoreList.this);
