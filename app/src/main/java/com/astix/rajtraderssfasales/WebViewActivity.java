...
public class WebViewActivity extends BaseActivity
{
    ...
    public String selectedStoreID="0";
    ...
    public void customHeader()
    {
        ...
        else if(comeFrom.equals("StoreSelectionForReOrder"))
        {
            tv_heading.setText("Modify Order");
        }
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       imei = AppUtils.getToken(this);
        ...
        if(Retry==0);
        {
            ...
            {
                selectedStoreID=intentData.getStringExtra("selStoreID");
            }
        ...
        if(isOnline())
        {
            ...
            try
            {
                ...
                {
                    ImageUrl= CommonInfo.MTAS_ORDER_WEB_URL.trim();
                    ImageUrl=ImageUrl+""+AppUtils.getToken(WebViewActivity.this)+"&StoreID="+selectedStoreID+"";
                }
                else
                {
