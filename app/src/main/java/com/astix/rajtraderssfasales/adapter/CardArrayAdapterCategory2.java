...
import com.astix.rajtraderssfasales.CategoryCommunicator;
import com.astix.rajtraderssfasales.R;

import java.util.ArrayList;
import java.util.List;

public class CardArrayAdapterCategory2 extends BaseAdapter {
	...
	public CardArrayAdapterCategory2(Context context, List<String> listStore, Dialog listDialog, String previousSlctdCtgry, int flgCompanyCompetitorProducts) {
