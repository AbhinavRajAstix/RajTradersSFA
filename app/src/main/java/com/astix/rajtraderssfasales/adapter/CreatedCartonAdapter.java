...
public class CreatedCartonAdapter extends RecyclerView.Adapter<CreatedCartonAdapter.ViewHolder> {
...
//    GetCartonPrdsInterface getCartonPrdsInterface;
    ...
    public CreatedCartonAdapter(Context context, List<TblProductCategoryUOMTypeList> createdCartonModelList, String date, String pickerDate, String SN, int flgOrderType, int catID/*, GetCartonPrdsInterface getCartonPrdsInterface*/) {
