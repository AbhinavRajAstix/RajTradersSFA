package com.astix.rajtraderssfasales.location;
...
public class LocationRetreivingGlobalDistributorScouting implements android.location.LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<LocationSettingsResult> {
    ...
    public String address="NA", pincode="0", city="NA", state="NA",District="NA";
    ...
    public void locationRetrievingAndDistanceCalculating(Activity context, final boolean isShowDialog, boolean fetchAdressFlag, int checkAccuracy, int flgtxtMsgType) {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                for (Location location : locationResult.getLocations()) {
                    if (location != null) {
                        ...
                        if (isShowDialog || location.getAccuracy()<40) {
                            stopLocationUpdates();
        ...
        if (isGooglePlayServicesAvailable()) {
            ...
            mGoogleApiClient = new GoogleApiClient.Builder(context)
                    ...
                    .addConnectionCallbacks(LocationRetreivingGlobalDistributorScouting.this)
                    .addOnConnectionFailedListener(LocationRetreivingGlobalDistributorScouting.this)
                    .build();
    ...
    private void fetchLocationFromGpsAndNetwork() {
        ...
        if (isGPSEnabled) {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, MIN_TIME_FOR_UPDATE, MIN_DISTANCE_FOR_UPDATE, LocationRetreivingGlobalDistributorScouting.this);
        }
        ...
        if (isNetworkEnabled) {
            ...
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, MIN_TIME_FOR_UPDATE, MIN_DISTANCE_FOR_UPDATE, LocationRetreivingGlobalDistributorScouting.this);
        }
    }
...
//            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, MIN_TIME_FOR_UPDATE, MIN_DISTANCE_FOR_UPDATE, this);
           ...
           /* AddressFromLauncher = allLoctionDetails.split(Pattern.quote("^"))[3];
            ...
            if (addresses != null && addresses.size() > 0){
                ...
                if(addresses.get(0).getAddressLine(0)!=null && addr.equals("NA")){
                    ...
                    addr=  getAddressNewWay(addresses.get(0).getAddressLine(0),city,state,zipcode,countryname,District);
    ...
    public String getAddressNewWay(String ZeroIndexAddress,String city,String State,String pincode,String country,String District){
        ...
        if(editedAddress.contains(District)){
            editedAddress=editedAddress.replace(District,"");
