...
public class LocationRetreivingGlobalWithMinTimeInterval implements android.location.LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<LocationSettingsResult> {
    ...
    public void locationRetrievingAndDistanceCalculating(Activity context, boolean isShowDialog, boolean fetchAdressFlag, int checkAccuracy, int flgtxtMsgType) {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                for (Location location : locationResult.getLocations()) {
                    if (location != null) {
                        ...
                        if (isShowDialog || location.getAccuracy()<checkAccuracy) {
        ...
        if (isGooglePlayServicesAvailable()) {
            ...
            mGoogleApiClient = new GoogleApiClient.Builder(context)
                    ...
                    .addConnectionCallbacks(LocationRetreivingGlobalWithMinTimeInterval.this)
                    .addOnConnectionFailedListener(LocationRetreivingGlobalWithMinTimeInterval.this)
                    .build();
...
//            countDownTimer.start();
            countDownTimer = new CoundownClass(2000, 1000);
            countDownTimer.start();
        } else {
            countDownTimer = new CoundownClass(2000, 1000);
            countDownTimer.start();
    ...
    private void fetchLocationFromGpsAndNetwork() {
        ...
        if (isGPSEnabled) {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, MIN_TIME_FOR_UPDATE, MIN_DISTANCE_FOR_UPDATE, LocationRetreivingGlobalWithMinTimeInterval.this);
        }
        ...
        if (isNetworkEnabled) {
            ...
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, MIN_TIME_FOR_UPDATE, MIN_DISTANCE_FOR_UPDATE, LocationRetreivingGlobalWithMinTimeInterval.this);
        }
    }
