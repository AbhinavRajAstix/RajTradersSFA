...
public class TblActualVsTargetReport {
    ...
    private int ValTgtOrPrdctFlg;

    public int getValTgtOrPrdctFlg() {
        return ValTgtOrPrdctFlg;
    }

    public void setValTgtOrPrdctFlg(int valTgtOrPrdctFlg) {
        ValTgtOrPrdctFlg = valTgtOrPrdctFlg;
    }
