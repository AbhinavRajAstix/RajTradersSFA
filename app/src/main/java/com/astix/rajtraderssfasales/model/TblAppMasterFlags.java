...
public class TblAppMasterFlags {
    ...
    public Integer getFlgDBRStockCanSkipFillInDayStart() {
        return flgDBRStockCanSkipFillInDayStart;
    }

    public void setFlgDBRStockCanSkipFillInDayStart(Integer flgDBRStockCanSkipFillInDayStart) {
        this.flgDBRStockCanSkipFillInDayStart = flgDBRStockCanSkipFillInDayStart;
    }

    @SerializedName("flgDBRStockCanSkipFillInDayStart")
    @Expose
    private Integer flgDBRStockCanSkipFillInDayStart;
