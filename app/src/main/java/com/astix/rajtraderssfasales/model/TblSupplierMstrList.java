...
public class TblSupplierMstrList {
    ...
    private int flgMarkInActive;

    private int flgRequiredUpdate;

    public int getFlgRequiredUpdate() {
        return flgRequiredUpdate;
    }

    public void setFlgRequiredUpdate(int flgRequiredUpdate) {
        this.flgRequiredUpdate = flgRequiredUpdate;
    }

    public int getFlgMarkInActive() {
        return flgMarkInActive;
    }

    public void setFlgMarkInActive(int flgMarkInActive) {
        this.flgMarkInActive = flgMarkInActive;
    }
