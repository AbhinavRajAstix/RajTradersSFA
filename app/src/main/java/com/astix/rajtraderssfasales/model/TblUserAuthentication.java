...
public class TblUserAuthentication {
    ...
    @SerializedName("AllowedGeofence")
    @Expose
    private int AllowedGeofence;
    ...
    public int getAllowedGeofence() {
        return AllowedGeofence;
    }

    public void setAllowedGeofence(int allowedGeofence) {
        AllowedGeofence = allowedGeofence;
    }
