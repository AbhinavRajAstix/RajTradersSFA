...
public class TbltmpInvoiceHeaderCartonPlusOrder {
    ...
    public int getFlgTransferStatus() {
        return flgTransferStatus;
    }

    public void setFlgTransferStatus(int flgTransferStatus) {
        this.flgTransferStatus = flgTransferStatus;
    }
